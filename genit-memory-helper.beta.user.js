...
// @updateURL    https://github.com/devforai-creator/genit-memory-helper/raw/main/genit-memory-helper.beta.user.js
// @downloadURL  https://github.com/devforai-creator/genit-memory-helper/raw/main/genit-memory-helper.beta.user.js
// @license      MIT
// ==/UserScript==
...
(function () {
  ...
  try {
    ...
    localStorage.removeItem('gmh_kill');
  } catch (err) {
    console.warn('[GMHβ] failed to enable beta flag', err);
  }
