...
> **프로젝트 상태: Dual Memory v3.0.0 구현 완료**
> v3.0.0 (2025-12-01) 기준, Dual Memory Core 기능 구현 완료.
> 다음 목표: v3.1.0 UX Polish (진행 상태, 백업/복원)

**버전**: 3.0.0-roadmap (2025-12-01 갱신)
**현재 상태**: Dual Memory Core 완료 (청크화, 요약/Facts, IndexedDB 저장)
**다음 목표**: v3.1.0 UX Polish
...
v3.0.0 [Dual Memory] ✅         (완료: 2025-12-01) - 요약 + Facts 추출
    ↓
v3.1.0 [UX Polish] 📋           계획됨 - 진행 상태, 백업/복원 ← 다음 목표
    ↓
