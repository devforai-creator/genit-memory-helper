...
> **프로젝트 상태: Dual Memory v3.0.1 릴리즈**
> v3.0.1 (2025-12-01) 기준, Dual Memory Core + 버그 수정 완료.
> 다음 목표: v3.1.0 Meta Summary (메타 요약)

**버전**: 3.0.1-roadmap (2025-12-01 갱신)
**현재 상태**: Dual Memory Core 완료 (청크화, 요약/Facts, IndexedDB 저장)
**다음 목표**: v3.1.0 Meta Summary (계층적 요약)
...
v3.0.1 [Bug Fix] ✅             (완료: 2025-12-01) - 저장 로드 타이밍 수정
    ↓
v3.1.0 [Meta Summary] 📋        계획됨 - 메타 요약 (10개 청크 → 1개 통합) ← 다음 목표
    ↓
v3.2.0 [UX Polish] 📋           계획됨 - 프롬프트 커스터마이징, 백업/복원
    ↓
...
| **v3.1.0** | Meta Summary | 10개 청크 요약 → 1개 메타 요약, 계층적 복사 | 📋 계획됨 |
