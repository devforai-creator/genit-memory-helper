...
**버전**: 2.1 (2025-10-24 갱신)
**현재 상태**: v2.1.0 Infrastructure 완료 ✅
**다음 목표**: v2.2.0 Semantic Search (BGE-M3 임베딩 + 검색 UI)
...
v2.1.0 [Infrastructure] ✅   (완료: 2025-10-24)
    ↓
v2.2.0 [Semantic Search]     ← 다음 목표 (3-4주, 25-35h)
    ↓
...
| 버전 | 목표 | 핵심 기능 | 우선순위 | 상태 |
|------|------|----------|----------|------|
| **v2.2.0** | 의미 검색 알파 | BGE-M3, 검색 UI, 맥락 재구성 | 🔴 HIGH | ⏳ 다음 |
| **v2.3.0** | 성능 최적화 | 자동 로더 캐싱, 매직 넘버 상수화 | 🟡 MEDIUM | 📋 계획 |
| **v2.4.0+** | 고급 기능 | Ollama 연동, 시간 필터, 태깅 | 🟢 LOW | 📋 계획 |
